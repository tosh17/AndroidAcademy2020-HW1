...
object KotlinWorkshop3 {
    ...
    private fun printTotalCountOfGuesses(guessCounter: Int) {
        println("Total guesses count: $guessCounter")
    }
    ...
    private fun countHigherGuesses(
        ...
        var counter = 0
        counter=guesses.count{it>randomNumber}
        printer(counter)
        return counter
    }
    ...
    val countLowerGuesses: (IntArray, Int) -> Unit = { guesses, randomNumber ->
        println("count guesses that were lower than randomNumber = ${guesses.count{it<randomNumber}}")
    }
